  ...
  return (
    <nav className="w-full h-[12svh] sticky top-0 z-50 flex justify-center items-center bg-white">
      <div className="w-11/12 flex justify-between items-center relative">
        ...
        <div
          className={` p-4 flex flex-col justify-center items-center gap-5 absolute top-14 right-[-1rem]  w-[110%] bg-gray-100 backdrop-filter backdrop-blur-sm bg-opacity-70 md:right-[-2.5rem] lg:hidden ${
            isOpen ? "block" : "hidden"
          }`}
        >
          {navbarLinks.map((link, i) => (
